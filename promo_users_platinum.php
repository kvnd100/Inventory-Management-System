                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info" role="alert">
                            <b><i class="bi bi-wallet-fill"></i> Platinum Category Users</b>
                        </div>

                        <br>

                        <form method="POST" action="server/APIs/store_user_platinum.php">
                            <div class="row">
                                <div class="col">
                                    <label for="inputFName" class="form-label text-secondary">First Name</label>
                                    <input type="text" class="form-control" aria-label="First name" name="txtFirstName" id="txtFirstName" required>
                                </div>
                                <div class="col">
                                    <label for="inputLName" class="form-label text-secondary">Last Name</label>
                                    <input type="text" class="form-control" aria-label="Last name" name="txtLastName" id="txtLastName" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="email" class="form-control" aria-label="Email" name="txtEmail" id="txtEmail" required>
                                </div>
                                <div class="col">
                                    <label for="inputMobile" class="form-label text-secondary">Mobile number</label>
                                    <input type="text" class="form-control" aria-label="Mobile number" name="txtMobile" id="txtMobile" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="col input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" aria-label="Promo Value" name="txtPromoValue" id="txtPromoValue" aria-describedby="basic-addon1" value="0">
                                    </div>
                                </div>
                                <div class="col">
                                    ...
                                    <div class="col input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Rs.</span>
                                        <input type="text" class="form-control" aria-label="Last Purchase" name="txtLastPurchase" id="txtLastPurchase" aria-describedby="basic-addon1" value="0">
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control" aria-label="Date" name="txtDate" id="txtDate" required>
                                </div>
                                <div class="col">
                                    <label for="inputEmployee" class="form-label text-secondary">Added by</label>
                                    <select class="form-select" aria-label="Default select" name="txtAddedBy" id="txtAddedBy">
                            ...
                            <div class="row">
                                <div class="col-12 d-flex flex-row-reverse">
                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a class="refreshButton" href="server/APIs/refresh_promo_users_platinum.php"><i class="bi bi-x-lg"></i> Cancel</a></button>
                        ...
                        <table class="table table-hover table-sm shadow-sm p-3 mb-5 bg-white rounded">
                            ...
                            <tbody class="text-secondary">
                                <?php 
                                    ...
                                    $sql = "SELECT * from promo_users WHERE category='Platinum'";
                                    $result = $conn->query($sql);
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . "<a href='#'><button type='button' class='btn btn-sm btn-outline-secondary'><i class='bi bi-info-circle'></i></button></a>" . " " . "<a href='#'><button type='button' class='btn btn-sm btn-outline-success'><i class='bi bi-pencil-square'></i></button></a>" . " " . "<a href='server/APIs/delete_user_platinum.php?rn=$row[id]'><button type='button' class='btn btn-sm btn-outline-danger'><i class='bi bi-trash3'></i></button></a>" . "</td>";
                                            echo "<tr>";
                                        }
                                        }
                                    } else {
