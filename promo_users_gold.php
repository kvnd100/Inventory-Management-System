                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                            <b><i class="bi bi-wallet-fill"></i> Gold Category Users</b>
                        </div>

                        <br>

                        <form method="POST" action="server/APIs/store_user_gold.php">
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-12 d-flex flex-row-reverse">
                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a class="refreshButton" href="server/APIs/refresh_promo_users_gold.php"><i class="bi bi-x-lg"></i> Cancel</a></button>
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-sm shadow-sm p-3 mb-5 bg-white rounded">
                            ...
                            <?php 
                                    ...
                                    $sql = "SELECT * from promo_users WHERE category='Gold'";
                                    $result = $conn->query($sql);
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . "<a href='#'><button type='button' class='btn btn-sm btn-outline-secondary'><i class='bi bi-info-circle'></i></button></a>" . " " . "<a href='#'><button type='button' class='btn btn-sm btn-outline-success'><i class='bi bi-pencil-square'></i></button></a>" . " " . "<a href='server/APIs/delete_user_gold.php?rn=$row[id]'><button type='button' class='btn btn-sm btn-outline-danger'><i class='bi bi-trash3'></i></button></a>" . "</td>";
                                            echo "<tr>";
                                        }
                                        }
                                    } else {
